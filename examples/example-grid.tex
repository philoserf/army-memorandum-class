...
\logo{assets/placeholder-seal}
\department{United States Army Example Command}
\address{Example Garrison Headquarters}
\address{1000 Example Avenue}
\address{FORT EXAMPLE, ST~~12345-1234}
\officesymbol{EXC-HQ-OPS}
\signaturedate{10 April 2019}
\documentmark{UNCLASSIFIED//FOR TRAINING USE ONLY (EXAMPLE)}

% If the subject spills into a 2nd line, it breaks \pagedesign from layout, but otherwise seems to work
\subject{On the use and testing of \LaTeX\ for document production}% and system documentation for the Example Command staff}

% \mfr

\multimemothru{U.S. Army Command and General Staff College (ATZL), 100 Stimson Avenue, Ft Leavenworth, KS 66027-1352}
\multimemothru{CHIEF OF STAFF, 1\st\ Example Battalion, Example Brigade, Example Division, United States Army}
\memoline{FOR Commanding General, United States Army Example Command, Fort Example, ST 12345-1234}

% \memoline{MEMORANDUM THRU CHIEF OF STAFF, 1\st\ Example Battalion, Example Brigade, Example Division, United States Army}
...
\adddistro{COL A. Adams}
\adddistro{LTC B. Brooks}
\adddistro{MAJ C. Carter}
\adddistro{MAJ D. Dawson}
\addcf{Example J3}
\addcf{Example G3}
